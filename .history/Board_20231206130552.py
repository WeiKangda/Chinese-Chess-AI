...
class Board:
    def __init__(self,p1,p2):
        ...
        self.op_pieces = [104, 203,205,302,  306,401,  407,500,  508, 621, 627, 730,  732,  734, 736, 738]
        self.my_pieces = [-194, -293,  -295,-392,  -396, -491,  -497,-590, -598, -671, -677, -760,  -762,  -764, -766, -768]
    ...
    def not_end(self):
        ...
        if my_king%10 == op_king%10:
            ...
            for i in range(my_king//10+1,op_king//10):
                print(self.situation[i])
                print(self.situation[i][op_king%10])
